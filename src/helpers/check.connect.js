...
const checkOverloadConnections = () => {
    setInterval( () => {
        ...
        console.log(`memory Usage = ${memoryUsage / 1024 / 1024} MB, maxConnections = ${maxConnections}`);

        if ( numConnection > maxConnections ) {
            console.log(`Overload connections detected! Current: ${numConnection}, Max allowed: ${maxConnections}`);
...
module.exports = {
    countConnect, checkOverloadConnections
};